    ...
    success: function(results) {
      if (results.length > 0) {
        ...
        if( (0<=rand) && (rand<shareA)){
            response.success('{"expname":"A","share":"'+object.get('shareA')+'","pipeheight":"'+ object.get('pipeheightA')+'"}');
        }else{
            response.success('{"expname":"B","share":"'+object.get('shareB')+'","pipeheight":"'+ object.get('pipeheightB')+'"}');
